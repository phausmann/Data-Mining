...
public class InteraktivRegelZeichnung extends Component {
	...
	private int pos;
		...
		public InteraktivRegelZeichnung(Vector<InteraktivKomponenten> speichersteine) {
			this.speichersteine = new Vector<InteraktivKomponenten>();
		...
		public Vector<InteraktivKomponenten> getSpeichersteine() {
